(function () {
    ...
    function hoursController(hoursService) {
        ...
        function _createEntry() {
            vm.form.TotalHoursWorked = vm.form.DirectClientContact + vm.form.IndirectClientHours;
        ...
        function _updateEntry() {
            vm.form.TotalHoursWorked = vm.form.IndirectClientHours + vm.form.DirectClientContact;
